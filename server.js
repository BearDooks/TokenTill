...
// Helper: Extract all text recursively from various message schemas (including thoughts, structured content, shared chats)
...
function parseSingleChat(chatData, userMap = {}) {
  ...
  const rawTitle = chatData.title || (chatObj && chatObj.title) || (chatObj && chatObj.chat && chatObj.chat.title) || 'Untitled Conversation';
